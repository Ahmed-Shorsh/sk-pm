...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 14, 2025 at 10:17 AM
...
INSERT INTO `users` (`user_id`, `name`, `email`, `password_hash`, `role_id`, `dept_id`, `phone`, `position`, `birth_date`, `hire_date`, `rating_window_days`, `active`, `email_verified`, `email_verification_token`, `email_verification_expires`) VALUES
(1, 'Ahmed Shorsh Hamad', 'ahmad.shorsh@southkurdistan.com', '$2y$10$tyKZ4sV8GEd9M15wkrrkdu8HctVagMUChZIgdXkpohUt/uMFEatui', 3, 2, '+9647719921065', 'Sales Officer', '2000-08-26', '2023-09-01', 0, 1, 0, 'fd321bee828388f18d85687e865305361e51e12439dedea7d58c9155e967d806', '2025-06-17 09:37:51'),
(2, 'Test', 'shorsh907@gmail.com', '$2y$10$PhMas541E53NTMCjlXh3SOB7zLDRqdmJWEvPS0Fa5on3uugkv2ZMS', 1, 3, '+1234567890', 'Sales Officer', '2013-02-18', '2025-06-24', 0, 1, 0, 'ddacd6229eabe11a5849ade29e1ce8f2b5bce3c0e30ed9072172c920f8ceadee', '2025-06-17 10:35:25'),
(3, 'Sara Abbas', 'sara.abbas@southkurdistan.com', '$2y$10$tyKZ4sV8GEd9M15wkrrkdu8HctVagMUChZIgdXkpohUt/uMFEatui', 2, 1, '+9647700000001', 'HR Manager', '1985-04-10', '2020-01-15', 2, 1, 1, NULL, NULL),
(4, 'Ali Mohammed', 'ali.mohammed@southkurdistan.com', '$2y$10$tyKZ4sV8GEd9M15wkrrkdu8HctVagMUChZIgdXkpohUt/uMFEatui', 2, 2, '+9647700000002', 'Finance Manager', '1980-11-13', '2019-05-10', 2, 1, 1, NULL, NULL),
(5, 'Farah Karim', 'farah.karim@southkurdistan.com', '$2y$10$tyKZ4sV8GEd9M15wkrrkdu8HctVagMUChZIgdXkpohUt/uMFEatui', 3, 1, '+9647700000003', 'Recruiter', '1995-02-20', '2024-03-01', 0, 1, 1, NULL, NULL),
(6, 'Omar Hameed', 'omar.hameed@southkurdistan.com', '$2y$10$tyKZ4sV8GEd9M15wkrrkdu8HctVagMUChZIgdXkpohUt/uMFEatui', 3, 3, '+9647700000004', 'IT Support', '1992-07-12', '2022-08-15', 0, 1, 1, NULL, NULL),
(7, 'Layla Qadir', 'layla.qadir@southkurdistan.com', '$2y$10$tyKZ4sV8GEd9M15wkrrkdu8HctVagMUChZIgdXkpohUt/uMFEatui', 2, 3, '+9647700000005', 'IT Manager', '1987-09-05', '2018-11-01', 2, 1, 1, NULL, NULL);
...
--
ALTER TABLE `department_indicator_monthly`
  MODIFY `snapshot_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
