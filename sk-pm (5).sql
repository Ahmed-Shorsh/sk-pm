...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 20, 2025 at 11:59 AM
...
(1, 'HR', 3, NULL),
(2, 'Finance', 4, '\\\\192.168.10.252\\Plan\\HR Plans'),
(3, 'IT', 7, NULL);
...
INSERT INTO `department_indicator_monthly` (`snapshot_id`, `indicator_id`, `dept_id`, `month`, `custom_name`, `is_custom`, `target_value`, `weight`, `unit_of_goal`, `unit`, `way_of_measurement`, `created_by`, `actual_value`, `notes`, `created_at`, `audit_score`) VALUES
(2, 2, 2, '2025-05-01', NULL, 0, 5, 30, '%', '%', 'Monthly financial report', 4, 4.2, 'Under budget', '2025-05-31 20:59:59', 2.5),
(3, 3, 3, '2025-05-01', NULL, 0, 99.9, 50, '%', '%', 'Monitoring dashboard', 7, 99.7, 'Minor outage on 12 May', '2025-05-31 20:59:59', 2.5),
...
(6, 6, 1, '2025-07-01', '', 0, 4, 5, '', '', '', 19, NULL, NULL, '2025-07-19 15:09:23', 2.5);
...
(5, 19, 5, 1, '2025-07-01', 3, 'df', '2025-07-19 08:16:05'),
(6, 19, 5, 4, '2025-07-01', 2, 'df', '2025-07-19 08:16:05'),
(7, 19, 5, 2, '2025-07-01', 2, 'df', '2025-07-19 08:16:05'),
(8, 19, 21, 1, '2025-07-01', 3, 'd', '2025-07-19 08:16:05'),
(9, 19, 21, 4, '2025-07-01', 1, 'd', '2025-07-19 08:16:05'),
(10, 19, 21, 2, '2025-07-01', 2, 'd', '2025-07-19 08:16:05'),
...
--
ALTER TABLE `individual_evaluations`
  MODIFY `evaluation_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
